...
declare type GridColDefOverride<ForcedFields extends keyof GridColDef> = Omit<Partial<GridColDef>, ForcedFields>;
declare type GridColDefOverrideCallback<ForcedFields extends keyof GridColDef> = (params: GridColDefOverrideParams) => GridColDefOverride<ForcedFields>;
...
declare const DataGrid: React$1.MemoExoticComponent<React$1.ForwardRefExoticComponent<Omit<GridInputComponentProps, "apiRef" | "checkboxSelectionVisibleOnly" | "disableColumnResize" | "disableColumnReorder" | "disableMultipleColumnsFiltering" | "disableMultipleColumnsSorting" | "disableMultipleSelection" | "disableChildrenFiltering" | "disableChildrenSorting" | "throttleRowsMs" | "hideFooterRowCount" | "options" | "onRowsScrollEnd" | "scrollEndThreshold" | "treeData" | "getTreeDataPath" | "groupingColDef" | "defaultGroupingExpansionDepth" | "signature"> & {
